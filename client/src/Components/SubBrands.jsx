        ...
        <TabPanels>
            ...
            <Flex>
                <Flex justifyContent={'center'} w={'40%'}>
                    ...
                    <Box w={'50%'}>
                    <Text fontFamily={'Playfair Display'}>Welcome to Minu Enhance Developers, a special partnership formed in 2021 by Minu Group and Enhance Group. Minu Group started in 1987 and has grown from a marketing agency to a big player in Retail, Entertainment, FMCG, Logistics, Warehousing, and Real Estate across 10 states and 2 Union Territories in India.   <br />
