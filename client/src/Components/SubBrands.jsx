...
return (
    ...
    <Box w={'90%'} m={'auto'} background={'white'}>
        ...
        <TabList mb='1em'>
            <Tab fontSize={['12px','16px','24px','20px']} fontFamily={'Playfair Display'}>Enhance Projects Pvt Ltd</Tab>
            <Tab fontSize={['12px','16px','24px','20px']} fontFamily={'Playfair Display'}>Minu Enhance Developers </Tab>
            <Tab fontSize={['12px','16px','24px','20px']} fontFamily={'Playfair Display'}>M/S M.C Jain</Tab>
            <Tab fontSize={['12px','16px','24px','20px']} fontFamily={'Playfair Display'}>M/S Ajay Kumar Jain</Tab>
        </TabList>
        <TabPanels>
            <TabPanel fontSize={'16px'}>
                <Flex direction={['column','column','row','row']}>
                    <Flex justifyContent={'center'} w={['95%','95%','40%','40%']}>
                    <Image w={'290px'} h={'170px'} src={Logo}/>
                    </Flex>
                    <Box w={['95%','95%','50%','50%']}>
